...
class simpleColumnar {
  public static void main(String sap[]) {
    ...
    /*
     * plainText and cipherText would be array containing ASCII values for
  ...
  static int[][] encrypt(int plainText[][], int cipherText[][], String message, int rowCount, int columnCount,
      String key) {
    int i, j;
    int k = 0;
    ...
    for (i = 0; i < columnCount; i++) {
      /*
       * currentCol would have current column number i.e. to be read...as there would
       * be ASCII value stored in key so we would subtract it by 48 so that we can get
       * the original
  ...
  static int[][] decrypt(int plainText[][], int cipherText[][], String message, int rowCount, int columnCount,
      String key) {
    int i, j;
    int k = 0;
    for (i = 0; i < columnCount; i++) {
